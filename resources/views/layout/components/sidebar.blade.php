<!-- Sidebar -->
<aside id="mobile-menu" class="bg-gray-900 w-40 mt-24 sm:w-48 h-full absolute top-0 left-0 -translate-x-full transition-transform duration-300 z-20 lg:static lg:translate-x-0 lg:mt-8 lg:ml-0">
